...
PrivateRoaming::PrivateRoaming(QWidget *parent)
	: QWidget(parent)
{
	ui.setupUi(this);
}

PrivateRoaming::~PrivateRoaming()
{}

QWidget* PrivateRoaming::GetWidget()
{
...
QString PrivateRoaming::OpenQssFile(const std::string& _qssFile)
{
...
void PrivateRoaming::SettingQss(const QString& _qss)
{
}
